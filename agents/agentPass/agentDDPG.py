...
class AgentDDPG:
    ...
    def __init__(self, name='DDPG',
                 maxEpisodes=120001, maxSteps=150, batchSize=256, replayBufferSize=1_000_000, valueLR=1e-4, policyLR=1e-4,
                 hiddenDim=256, nEpisodesPerCheckpoint=5000, ckpt_stem='checkpoint', env_str="grSimSSLPass-v0"):
        # Training Parameters
